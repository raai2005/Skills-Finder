  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.oldSchoolContainer}>
        ...
        {/* Skills in Demand - Old School Style */}
      ...
      {/* Team Member Profile - Old School Style */}
      <ThemedView style={styles.osSection}>
        <ThemedText style={styles.osMenuTitle}>[ YOUR PROFILE ]</ThemedText>
        <View style={styles.osDivider}></View>
        <TeamMemberProfile member={member} onUpdate={handleUpdateProfile} />
      </ThemedView>
      
      {/* Upcoming Project Notifications - Old School Style */}
      <ThemedView style={styles.osSection}>
