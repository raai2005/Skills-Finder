// Fixed version of index_old.tsx
// This file is automatically generated to fix the JSX closing tag issue
      ...
      <ThemedView style={styles.osSection}>
        ...
        <View style={styles.osProjectCard}>
          ...
          <View style={styles.teamMembersRow}>
            <ThemedText style={{marginRight: 8}}>Team:</ThemedText>
            <View style={styles.avatarStack}>
              <View style={[styles.avatar, {backgroundColor: '#4287f5'}]}><ThemedText style={styles.avatarText}>B</ThemedText></View>
              <View style={[styles.avatar, {backgroundColor: '#42c5f5'}]}><ThemedText style={styles.avatarText}>C</ThemedText></View>
              <View style={[styles.avatar, {backgroundColor: '#f5a142'}]}><ThemedText style={styles.avatarText}>D</ThemedText></View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.osProjectCard}>
          ...
          <View style={styles.teamMembersRow}>
            <ThemedText style={{marginRight: 8}}>Team:</ThemedText>
            <View style={styles.avatarStack}>
              <View style={[styles.avatar, {backgroundColor: '#42f5d7'}]}><ThemedText style={styles.avatarText}>A</ThemedText></View>
              <View style={[styles.avatar, {backgroundColor: '#b8f542'}]}><ThemedText style={styles.avatarText}>B</ThemedText></View>
            </View>
          </View>
        </View>
      </ThemedView>
